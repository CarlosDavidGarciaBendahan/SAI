			...
			<div class="col-sm-8 offset-2">
				{!! Form::open(['route' => ['marca.update',$marca], 'method' => 'PUT' ]) !!}
					...
					<div class="form-group"> 
						...
						{!! Form::text('mar_marca',$marca->mar_marca,['class'=> 'form-control', 'title'=>'Solo letras mayúsculas, minúsculas y números de 0-9, min: 3 max: 20', 'placeholder'=>'Marca.', 'required', 'minlength'=>'3', 'maxlength' => '20', 'pattern'=>'[A-za-z0-9 ]+']) !!}
					</div>
