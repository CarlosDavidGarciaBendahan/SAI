				...
				{!! Form::open(['route' => 'cliente_natural.store', 'method' => 'POST' ]) !!}
					...
					<div class="row"><!-- DIRECCION-->
						<div class="form-group col-sm-6">
							...
							{!! Form::text('cli_nat_direccion',$cliente_natural->cli_nat_direccion,['class'=> 'form-control', 'placeholder'=>'dirección', 'required', 'readonly'=>'true']) !!}
						</div>

						<div class="form-group col-sm-2">
							<label>Parroquia</label>
							<select class="form-control input-sm" name="cli_nat_fk_parroquia" id="parroquia" disabled="true">
					...
					<div class="row"><!-- DATOS IDENTIFICACION-->
						<div class="form-group col-sm-2">
							...
							{!! Form::text('cli_nat_nombre',$cliente_natural->cli_nat_nombre,['class'=> 'form-control', 'placeholder'=>'Nombre', 'required','readonly'=>'true']) !!}
						</div>
					
						<div class="form-group col-sm-2">
							{!! Form::label('cli_nat_nombre2','Segundo nombre') !!}
							{!! Form::text('cli_nat_nombre2',$cliente_natural->cli_nat_nombre2,['class'=> 'form-control', 'placeholder'=>'Segundo nombre','readonly'=>'true']) !!}
						</div>
					
						<div class="form-group col-sm-2">
							{!! Form::label('cli_nat_apellido','Apellido') !!}
							{!! Form::text('cli_nat_apellido',$cliente_natural->cli_nat_apellido,['class'=> 'form-control', 'placeholder'=>'Apellido', 'required','readonly'=>'true']) !!}
						</div>
					
						<div class="form-group col-sm-2">
							{!! Form::label('cli_nat_apellido2','Segundo apellido') !!}
							{!! Form::text('cli_nat_apellido2',$cliente_natural->cli_nat_apellido2,['class'=> 'form-control', 'placeholder'=>'Segundo apellido','readonly'=>'true']) !!}
						</div>
						...
						<div class="col-sm-6">
							<table class="table table-inverse">
							  ...
							  <tbody>
							  	...
							  	@foreach ($cliente_natural->Contacto_Correos as $contacto_correo)
							  		<tr>
						...
						<div class="col-sm-6">
							<table class="table table-inverse">
							  ...
							  <tbody>
							  	...
							  	@foreach ($cliente_natural->Contacto_Telefonos  as $contacto_telefono)
							  		<tr>
